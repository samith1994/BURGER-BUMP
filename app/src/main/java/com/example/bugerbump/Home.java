...
public class Home extends AppCompatActivity
{
    ...
    private ImageView profileBtn, cartBtn;
    private RecyclerView foodList;
    private DatabaseReference foodsDatabaseReference;

    private String _username, _email, _phoneNo, _password;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cartBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent cartViewIntent = new Intent(Home.this, CartViewActivity.class);
                cartViewIntent.putExtra("phoneNo",_phoneNo);
                startActivity(cartViewIntent);
            }
        });
        ...
        FirebaseRecyclerAdapter<foods,FoodViewHolder> adapter = new FirebaseRecyclerAdapter<foods, FoodViewHolder>(options)
        {
            ...
            protected void onBindViewHolder(@NonNull final FoodViewHolder foodViewHolder, int i, @NonNull final foods foods)
            {
                ...
                foodViewHolder.itemView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view)
                    {
                        PopupMenu(foodID, foods.name, foods.price, "1");
                    }
                });
            }
    ...
    //home menu
    private void PopupMenu(final String foodID, final String foodName, final String foodPrice, final String qty)
    {
        ...
        cartBtn.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View v)
            {
                ...
                cartIntent.putExtra("phoneNo",_phoneNo);
        ...
        buyBtn.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View v)
            {
                ...
                checkoutIntent.putExtra("foodPrice",foodPrice);
                checkoutIntent.putExtra("qty",qty);
                checkoutIntent.putExtra("foodName",foodName);
